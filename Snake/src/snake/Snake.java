...
public class Snake extends Application {
    ...
    private static final String [] FOODS_IMAGE = new String[]{"/Image/apple.png","/Image/cherry.png","/Image/grape.png","/Image/orange.png","/Image/pear.png"};
    ...
    private void drawBackground(GraphicsContext gc){
        for(int i = 0; i< ROWS; i++){
            for(int j = 0; j < COLUMNS; j++){
                if((i + j) % 2 == 0){
                    gc.setFill(Color.web("463AA0"));
                }
                else{
                    gc.setFill(Color.web("DB77FF"));
                }
